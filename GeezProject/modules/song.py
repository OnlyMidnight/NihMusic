...
def song(client, message):
    ...
    try:
        ...
        m.edit("❌ Lagu Tidak Di Temukan.\n\nCoba Masukan Judul Lagu Yang Lebih Jelas Dan Detail.")
        print(str(e))
        return
    m.edit("🔄 Sedang Mendownload Lagu..Sabar Yak!! ")
    try:
        with youtube_dl.YoutubeDL(ydl_opts) as ydl:
            info_dict = ydl.extract_info(link, download=False)
            audio_file = ydl.prepare_filename(info_dict)
            ydl.process_info(info_dict)
        rep = "**Berhasil Mengunduh Lagu🎶\n🌻 ᴄʜᴀɴɴᴇʟ: @infobotmusik \n☕ ᴍᴀɴᴀɢᴇᴅ ʙʏ: [ARI](https://t.me/SilenceSpe4ks)"
